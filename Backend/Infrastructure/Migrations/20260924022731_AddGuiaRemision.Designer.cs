...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260924022731_AddGuiaRemision")]
    partial class AddGuiaRemision
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Anfitriona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Domain.Entities.CajaFisica", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.CategoriaGasto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.CierreDiario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.ClienteCuenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Cobranza", b =>
                {
                    ...
                    b.Property<string>("EstadoCobranza")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
            ...
            modelBuilder.Entity("Domain.Entities.CobranzaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.ComprobanteCabecera", b =>
                {
                    ...
                    b.Property<bool>("StockYaDescontado")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.EntregaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("PedidoVentaDetalleId");

                    b.ToTable("EntregaDetalle");
                });
            ...
            modelBuilder.Entity("Domain.Entities.GastoPublicidad", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal>("ImporteGastado")
                        .HasColumnType("numeric(13,2)");
                    ...
                    b.Property<string>("NombreAnuncio")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");

                    b.Property<string>("NombreConjuntoAnuncios")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");

                    b.Property<int?>("Resultados")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.GuiaRemision", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ChoferDocumento")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
                    ...
                    b.Property<string>("TransportistaMtc")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
                    ...
                    b.Property<string>("UbigeoLlegada")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");

                    b.Property<string>("UbigeoPartida")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");

                    b.Property<string>("UndPesoTotal")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
            ...
            modelBuilder.Entity("Domain.Entities.GuiaRemisionDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Identity.Role", b =>
                {
                    ...
                    b.Property<string>("RutaPorDefecto")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
                    ...
                    b.HasIndex("NormalizedName", "TenantId")
                        .IsUnique()
                        .HasDatabaseName("RoleNameTenantIndex");

                    b.ToTable("AspNetRoles", (string)null);
                });

            modelBuilder.Entity("Domain.Entities.Identity.RoleSubmodule", b =>
                {
            ...
            modelBuilder.Entity("Domain.Entities.Impuesto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Moneda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.PagoProveedor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.PagoProveedorDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PagoProveedorDetalle");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Pais", b =>
                {
                    ...
                    b.Property<string>("EsquemaFiscal")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("character varying(50)");
            ...
            modelBuilder.Entity("Domain.Entities.Pedido", b =>
                {
                    ...
                    b.Property<bool>("PasswordEnviado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("Domain.Entities.PedidoVenta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("EstadoPedidoVenta")
                        .HasMaxLength(150)
                        .HasColumnType("character varying(150)");
            ...
            modelBuilder.Entity("Domain.Entities.PedidoVentaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("PedidoVentaDetalle");
                });

            modelBuilder.Entity("Domain.Entities.PrecioAlternativo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.Producto", b =>
                {
                    ...
                    b.Property<bool>("GestionLotes")
                        .HasColumnType("boolean");

                    b.Property<int?>("GrupoId")
                        .HasColumnType("integer");

                    b.Property<bool>("Icbper")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("MultiPrecioActivo")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.Renta", b =>
                {
                    ...
                    b.Property<decimal>("MontoCuarto")
                        .HasColumnType("numeric(13,2)");
                    ...
                    b.Property<decimal>("TarifaCuarto")
                        .HasColumnType("numeric(13,2)");
            ...
            modelBuilder.Entity("Domain.Entities.RentaDetalle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.RubroModulo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RubroId", "CodigoModulo")
                        .IsUnique();

                    b.ToTable("RubroModulo");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Sucursal", b =>
                {
                    ...
                    b.Property<int?>("TenantIdentificador")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantIdentificador");
            ...
            modelBuilder.Entity("Domain.Entities.WhatsappConversation", b =>
                {
                    ...
                    b.Property<DateTime?>("UltimoMensaje")
                        .HasColumnType("timestamp without time zone");
                    ...
                    b.ToTable("WhatsappConversation");
                });

            modelBuilder.Entity("Domain.Entities.WhatsappMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.ClienteCuenta", b =>
                {
                    b.HasOne("Domain.Entities.Cliente", "Cliente")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.ClienteCuenta", "ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.CobranzaDetalle", b =>
                {
                    b.HasOne("Domain.Entities.Cobranza", "Cobranza")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("Domain.Entities.Entrega", b =>
                {
                    b.HasOne("Domain.Entities.PedidoVenta", "PedidoVenta")
                        .WithMany("Entregas")
            ...
            modelBuilder.Entity("Domain.Entities.EntregaDetalle", b =>
                {
                    b.HasOne("Domain.Entities.Entrega", "Entrega")
                        .WithMany("Detalles")
                        .HasForeignKey("EntregaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.PedidoVentaDetalle", "PedidoVentaDetalle")
                        .WithMany()
                        .HasForeignKey("PedidoVentaDetalleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Entrega");

                    b.Navigation("PedidoVentaDetalle");
                });
            ...
            modelBuilder.Entity("Domain.Entities.GuiaRemisionDetalle", b =>
                {
                    b.HasOne("Domain.Entities.GuiaRemision", "GuiaRemision")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("Domain.Entities.PagoProveedorDetalle", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.PagoProveedor", "PagoProveedor")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("Domain.Entities.Renta", b =>
                {
                    b.HasOne("Domain.Entities.Anfitriona", "Anfitriona")
                        .WithMany()
                        .HasForeignKey("AnfitrionaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Recurso", "Recurso")
                        .WithMany()
                        .HasForeignKey("RecursoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Anfitriona");
            ...
            modelBuilder.Entity("Domain.Entities.RentaDetalle", b =>
                {
                    b.HasOne("Domain.Entities.Renta", "Renta")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("Domain.Entities.Sucursal", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Tenant", null)
                        .WithMany("Sucursales")
                        .HasForeignKey("TenantIdentificador");
            ...
            modelBuilder.Entity("Domain.Entities.Producto", b =>
                {
                    ...
                    b.Navigation("PreciosAlternativos");
